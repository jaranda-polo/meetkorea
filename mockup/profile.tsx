      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-1">John Davis</h2>
            <p className="text-gray-600 mb-3">미국 · 초급 수준</p>
            <div className="flex space-x-2 mb-4">
              <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm">여행</span>
              <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm">일상 생활</span>
              <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm">K-Pop</span>
            </div>
        ...
        {/* 학습 현황 */}
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">학습 현황</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">주방, 욕실, 침실이 하나인 아파트</p>
              </div>
              <button className="text-gray-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path>
